...
struct SystemPasteboard: PasteboardReading {
    ...
    func isConcealed() -> Bool {
        ...
        let concealed: [NSPasteboard.PasteboardType] = [
            NSPasteboard.PasteboardType(rawValue: "org.nspasteboard.ConcealedType"),
            NSPasteboard.PasteboardType(rawValue: "org.nspasteboard.TransientType"),
            NSPasteboard.PasteboardType(rawValue: "org.nspasteboard.AutoGeneratedType"),
            NSPasteboard.PasteboardType(rawValue: "com.agilebits.onepassword"),
        ]
        return concealed.contains { types.contains($0) }
    }
}
